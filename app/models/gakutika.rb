class Gakutika < ApplicationRecord
    ...
    scope :eager_loading, -> { eager_load(user_and_company_and_gakutikas: [user_and_company: :user], user_and_companies: [:company, user_and_company_and_gakutikas: :gakutika]) }
