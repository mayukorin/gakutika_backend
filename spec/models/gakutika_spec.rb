...
RSpec.describe Gakutika, type: :model do
  ...
  context "内容がnilの場合" do
    ...
    it "無効" do
      ...
      expect(gakutika).not_to be_valid
      expect(gakutika.errors[:content]).to match(["内容を入力してください"])
    end
  end
  ...
  context "開始年月がnilの場合" do
    ...
    it "無効" do
      ...
      expect(gakutika).not_to be_valid
      expect(gakutika.errors[:start_month]).to match(["開始年月を入力してください"])
    end
  end
  ...
  context "終了年月がnilの場合" do
    ...
    it "無効" do
      ...
      expect(gakutika).not_to be_valid
      expect(gakutika.errors[:end_month]).to match(["終了年月を入力してください"])
    end
  end
  ...
  context "順位がnilの場合" do
    ...
    it "無効" do
      ...
      expect(gakutika).not_to be_valid
      expect(gakutika.errors[:tough_rank]).to match(["頑張り順を入力してください"])
    end
  end
  ...
  context "順位がかぶっている場合" do
    ...
    it "無効" do
      ...
      expect(gakutika2.errors[:tough_rank]).to match(["頑張り順が重複しています"])
    end
  end
