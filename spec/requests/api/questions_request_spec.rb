    ...
    describe "#create" do
      context "通常のquestionを登録する場合" do
        ...
        it 'status created と作成した質問を返す' do
          ...
          user_and_company_cnt = UserAndCompany.where(user_id: user.id, company_id: new_question.company.id).count
    ...
    describe "#update" do
      ...
      context "通常のquestionを更新する(companyは新しい)場合" do
        ...
        it 'status accepted と更新した質問を返す' do
          ...
          new_user_and_company = UserAndCompany.find_by(user_id: user.id, company_id: new_question.company.id)
          new_user_and_company_and_gakutika_cnt = UserAndCompanyAndGakutika.where(user_and_company: new_user_and_company.id, gakutika: new_question.gakutika.id).count
